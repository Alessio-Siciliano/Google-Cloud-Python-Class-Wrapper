...
class BigqueryClient:
    ...
    def __init__(
        ...
        ) and service_account_key_file_path == "":
        ...
        if service_account_key_file_path == "":
            ...
            self.client = bigquery.Client(
                project=project_id, location=location
            ).from_service_account_json(service_account_key_file_path)
    ...
    def get_list_of_datasets(self) -> list[dict]:
        """
        Return the entire list of datasets of the project.
        These datasets are children of the class DatasetListItem.
        ...
        -------
        List[dict()]
            A list of dictionary, where each dict() is a dataset instance
        """
    ...
    def get_dataset_by_name(self, dataset_name: str) -> "Dataset":
        ...
        dataset = self.client.get_dataset(
            DatasetReference.from_string(
                default_project=self.project_id, dataset_id=dataset_name
            )
        )
